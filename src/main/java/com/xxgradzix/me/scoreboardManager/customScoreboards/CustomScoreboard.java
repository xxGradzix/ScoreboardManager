...
import com.xxgradzix.me.scoreboardManager.customScoreboards.versioning.SpigotAPIVersion;
...
public abstract class CustomScoreboard {
  private CustomScoreboardOptions options;
  ...
  public CustomScoreboard(String id) {
    ...
    /// ScoreboardRegistry
    ScoreboardRegistry.INSTANCE.addScoreboardToRegistry(id, this);
  }
...
//    ScoreboardRegistry.INSTANCE.closeOtherAllScoreboardsForPlayer(player, id);
   ...
   */
  public Optional<CustomScoreboardTeam> findTeam(String name) {
    return teams.stream()
   ...
   */
  public CustomScoreboardTeam createTeam(String name, String displayName) throws DuplicateTeamCreatedException, ScoreboardTeamNameTooLongException {
   ...
   * @throws ScoreboardTeamNameTooLongException If the team's name is longer than 16 characters
   */
  public CustomScoreboardTeam createTeam(String name, String displayName, ChatColor teamColor) throws DuplicateTeamCreatedException, ScoreboardTeamNameTooLongException {
    for (CustomScoreboardTeam team : this.teams) {
    ...
    CustomScoreboardTeam team = new CustomScoreboardTeam(name, displayName, teamColor,this);
    team.refresh();
    this.teams.add(team);
    return team;
  }
   ...
   */
  public void removeTeam(CustomScoreboardTeam team) {
  ...
  public void destroy() {
    ...
    for (CustomScoreboardTeam team : teams) {
      team.destroy();
    }
   ...
   */
  public List<CustomScoreboardTeam> getTeams() {
    return teams;
  }
   ...
   */
  public CustomScoreboardOptions getOptions() {
    return options;
  }
  ...
  protected void updateScoreboard(Scoreboard scoreboard, List<String> lines) throws ScoreboardLineTooLongException {
    ...
    if (options.getTabHealthStyle() != CustomScoreboardTabHealthStyle.NONE) {
   ...
   */
  protected void setOptions(CustomScoreboardOptions options) {
